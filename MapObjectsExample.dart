...
class MapObjectsExample {
  final GeoCoordinates _berlinGeoCoordinates =
      new GeoCoordinates(28.449281, 77.583474);
  ...
  MapObjectsExample(HereMapController hereMapController)
    ...
    hereMapController.camera.lookAtPointWithMeasure(
        GeoCoordinates(28.449281, 77.583474), mapMeasureZoom);
  }
  ...
  MapPolygon _createMapCircle() {
    ...
    GeoCircle geoCircle =
        GeoCircle(GeoCoordinates(28.449281, 77.583474), radiusInMeters);
  ...
  void _flyTo(GeoCoordinates geoCoordinates) {
    ...
    MapCameraAnimation animation = MapCameraAnimationFactory.flyToWithZoom(
        geoCoordinatesUpdate, mapMeasure, bowFactor, Duration(seconds: 3));
