...
void _initializeHERESDK() async {
  ...
  String accessKeySecret =
      "EJTfj-5gYLyhv73w2LWG-Di3_liYI6CEfeJH1UQYlZoluT9WEOZyU0Z5KzNTpFTC49qo-QyZnJTeEYGz30e7Ng";
...
class _MyAppState extends State<MyApp> {
  ...
  Widget _buildLocationIndicatorExpansionTile(BuildContext context) {
    final List<MenuSectionItem> menuItems = [
      MenuSectionItem(
          "Location (Ped)", _locationIndicatorPedestrianButtonClicked),
      MenuSectionItem(
          "Location (Nav)", _locationIndicatorNavigationButtonClicked),
      MenuSectionItem("Location Active/Inactive",
